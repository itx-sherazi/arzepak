  ...
  const sendInquiry = async (e: React.FormEvent) => {
    ...
    try {
      await postInquiry({
        ...
        message: `Inquiry about project: ${project?.title}`,
      });
                ...
                <div className="text-right">
                  {project.minPrice && project.maxPrice ? (
                    <>
                      ...
                      <div className="text-xl font-bold text-green-700">{formatPriceFull(project.minPrice)}</div>
                      <div className="text-sm text-gray-500">to {formatPriceFull(project.maxPrice)}</div>
                    </>
                  ) : project.minPrice ? (
                    <>
